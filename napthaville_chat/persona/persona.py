...
from napthaville_chat.persona.memory.spatial import MemoryTree
from napthaville_chat.persona.memory.associative_memory import AssociativeMemory
from napthaville_chat.persona.memory.scratch import Scratch

# from napthaville_chat.persona.cognitive_modules.perceive import perceive
# from napthaville_chat.persona.cognitive_modules.retrieve import retrieve
# from napthaville_chat.persona.cognitive_modules.plan import plan
# from napthaville_chat.persona.cognitive_modules.reflect import reflect
# from napthaville_chat.persona.cognitive_modules.execute import execute
...
class Persona:
    ...
    # # async def execute(self, maze, persona_names, plan):
    # async def execute(self, persona_names: List[str]):
