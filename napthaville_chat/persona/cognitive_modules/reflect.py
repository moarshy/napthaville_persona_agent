...
from napthaville_persona_agent.persona.cognitive_modules.retrieve import *
...
def run_reflect(persona):
    ...
    for focal_pt, nodes in retrieved.items(): 
        ...
        for thought, evidence in thoughts.items(): 
            ...
            persona.a_mem.add_thought(created, expiration, s, p, o, thought, keywords, thought_poignancy, thought_embedding_pair, evidence)
...
def reflect(persona):
    ...
    # Check if chatting has ended and need to process conversation
    if persona.scratch.chatting_end_time: 
        ...
        # Generate and store memo thought
