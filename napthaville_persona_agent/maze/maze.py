...
file_path = Path(__file__).parent.parent.parent / "test_data/matrix"
...
class Maze: 
    def __init__(self, maze_name): 
        ...
        meta_info = json.load(open(f"{file_path}/maze_meta_info.json"))
        ...
        blocks_folder = f"{file_path}/special_blocks"
